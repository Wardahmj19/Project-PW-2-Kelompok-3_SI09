	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-xl-12 m-lr-auto">
				<form class="bg0 p-t-85 p-b-85" action="{{ route('produk.update', $produks) }}" method="POST">
					@csrf
                    @method('PUT')
					<div class="form-group row">
						...
						<div class="input-group">
							...
							<input id="kode" name="kode" type="text" class="form-control" value="{{ $produks->kode }}">
						</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="input-group">
							...
							<input id="nama_produk" name="nama_produk" type="text" class="form-control" value="{{ $produks->nama_produk }}">
						</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="input-group">
							...
							<input id="harga" name="harga" type="text" class="form-control" value="{{ $produks->harga }}">
						</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="input-group">
							...
							<input id="jumlah" name="jumlah" type="text" class="form-control" value="{{ $produks->jumlah }}">
						</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-8">
                            <select id="jenis_produk_id" name="jenis_produk_id" class="custom-select" value="{{ $produks->jenis_produk_id }}">
					...
					<div class="form-group row">
						<div class="flex-w flex-m m-r-20 m-tb-5 offset-5">
